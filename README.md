# ROCKNETSSH MANAGER MOD BY JALINGKUT TRIX
...
```
apt-get update -y; apt-get upgrade -y; wget https://raw.githubusercontent.com/rockneters/jalingkut/master/Plus; chmod 777 Plus; ./Plus
```
